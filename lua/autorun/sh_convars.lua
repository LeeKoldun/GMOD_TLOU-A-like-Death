...
-- Convars --
TD_CVAR_ENABLED = CreateConVar(CMD_PREFIX .. "enabled", "1", {FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Should TLOU a-like death be enabled", 0, 1)
TD_CVAR_DEATHMESSAGE = CreateConVar(SV_CMD_PREFIX .. "death_message", "", {FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Custom death message")
TD_CVAR_DEATHOFFSET = CreateConVar(SV_CMD_PREFIX .. "offset", "1", {FCVAR_ARCHIVE, FCVAR_REPLICATED}, "How far should offset the death screen sequence", 0.5, 2)
